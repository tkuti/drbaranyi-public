...
router.post("/:userId", checkUser, checkBody, async (req, res) => {
...
router.get("/byuser/:userId", checkUser, async (req, res) => {
...
router.get("/lastMessageByUsers", checkUser, checkUserAdminRole, async (req, res) => {
